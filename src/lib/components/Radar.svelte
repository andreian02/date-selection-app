<!--
  //@component
  Generates an SVG radar chart. Original colour #ff3399
 -->
 <script>
    ...
    /**  @type {String} [fill='#2b6cb0'] The radar's fill color. This is technically optional because it comes with a default value but you'll likely want to replace it with your own color. */
    export let fill = '#2b6cb0'
  
    /**  @type {String} [stroke='#2b6cb0'] The radar's stroke color. This is technically optional because it comes with a default value but you'll likely want to replace it with your own color. */
    export let stroke = '#2b6cb0'
    ...
    /**  @type {String} [circleFill="#2b6cb0"] Each circle's fill color. This is technically optional because it comes with a default value but you'll likely want to replace it with your own color. */
    export let circleFill = "#2b6cb0";
